...
public class Update extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(session.getAttribute("shoppingcart")==null){
            ...
            update = (everything.Cart)session.getAttribute("shoppingcart");
            everything.Item i = update.getItem(product);
            update.setQuantity(i, quantity);
        }
        //synchronized(session){
        session.setAttribute("shoppingcart", update);
...
//"		<br></br>\n" + 
//"		<p>\n" +
//"			You have " + product + " in your Cart!	Amount of " + product + "(s):"+ quantity + "\n");
//
//          out.print(
//"	</p>\n" +
//"	</body>\n" +
